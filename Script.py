...
👨‍💻 Cᴏᴍᴍᴀɴᴅ : /clone</b>"""
    ...
    SUBSCRIPTION_TXT = """
<b> sorry brother , we are providing this service for fee so you can use it any time. we will our best to not add premium plans.
 but you can refer this link to your friends.this will be saved in database. if i earn some money from telegram i will set giveaway for you who shared this link and earned refferal points.
