...
class script(object):
    ...
    ```I am File Sharing Bot by @filmykeedha
📚 With the biggest media database on Telegram, we've been serving users since 2021 and our plan to stay completely free in the future!
Hindi: 
मैं फ़ाइल शेयरिंग बॉट हूँ।
📚 टेलीग्राम पर सबसे बड़े मीडिया डेटाबेस के साथ, हम 2021 से उपयोगकर्ताओं को निःशुल्क सेवा प्रदान कर रहे हैं और भविष्य में पूरी तरह से मुफ़्त रहने की योजना है!```
...
ɪ ᴀᴍ ᴀᴅᴠᴀɴᴄᴇ ᴀɴᴅ ᴘᴏᴡᴇʀғᴜʟʟ ᴀᴜᴛᴏғɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴀᴍᴀᴢɪɴɢ ғᴇᴀᴛᴜʀᴇs ᴊᴜsᴛ ᴛʏᴘᴇ ᴡʜᴀᴛ ʏᴏᴜ ᴡᴀɴᴛ ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀ 💘</b>"""
    ...
    HELP_TXT = """<b>Hᴇʏ {} , Whats up? 
    ```[ 1️⃣ So I know That you are Thinking About How To Use bot. to use this bot have to do graduation then Ph.d in Telegram Bots 😆. Just Joking To use it just join search Group type Name of which movie you want. just it 
        2️⃣  Another important thing is that if you want to do something to run this boat in future, then share it. Apart from this, you can also give us financial help by clicking on the donate or /donate button. ]```
  
   ```[ 1️⃣ तो मुझे पता है कि आप सोच रहे होंगे कि बॉट का उपयोग कैसे करें। इस बॉट का उपयोग करने के लिए स्नातक होना चाहिए और फिर टेलीग्राम बॉट्स में पीएचडी करना होगा। बस मजाक कर रहा हूँ 😆। इसका उपयोग करने के लिए बस सर्च ग्रुप में शामिल हों जाइए, जो मूवी या वेब सीरीज देखना हैं उसका नाम टाइप करें। बस इतना ही हैं ।```
       2️⃣  एक और खास बात आप अगर इस बोट को भविष्य में भी चलाने के लिए कुछ करना चाहते है तो इसको शेयर करें। इसके अलावा donate ya /donate बटन पर क्लिक करके हमें आर्थिक सहायता भी दे सकते हैं।  ]```
