...
from database.ia_filterdb import col, sec_col, get_file_details, unpack_new_file_id, get_bad_files, fetch_file_by_link, get_batch_by_id
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for file_metadata in files_metadata:  # start=1 for sequence number
            try:
                ...
                file = await fetch_file_by_link(batch_id, unique_link)  # This function should retrieve the file from the store
                ...
                if file:
                    ...
                    msg = await client.send_cached_media(
                        chat_id=message.from_user.id,
                        file_id=unique_link if unique_link else file_id,  # Sending the file retrieved from the link
                        caption=caption,
